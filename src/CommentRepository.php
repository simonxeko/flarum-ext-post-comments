...
{
    /**
     * Get a new query builder for the comments table.
     *
     * @return Builder
     */
    ...
    /**
     * Find comments that match certain conditions, optionally making sure they
    ...
    /**
     * Find comments by their IDs, optionally making sure they are visible to a
     * certain user.
     *
     * @param array $ids
     * @param \Flarum\User\User|null $actor
    ...
    {
        $comments = $this->queryIds($ids, $actor)->get();

        $comments = $comments->sort(function ($a, $b) use ($ids) {
    ...
    /**
     * Filter a list of post IDs to only include comments that are visible to a
     * certain user.
     *
     * @param array $ids
     * @param User $actor
    ...
    {
        return $this->queryIds($ids, $actor)->pluck('comments.id')->all();
    }
    ...
    protected function queryIds(array $ids, User $actor = null)
    {
        ...
        return $this->whereIn('comments.id', $ids);
    }
}
